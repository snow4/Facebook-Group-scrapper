...
//                                    listItemsData(Totalcount);
                    ...
                    promise2 = new Promise(function(resolve, reject) {  
                                    var count=0,max_count=Totalcount;
                                    Looping(count);
...
//                                    console.log(a1.children[0].children[0].children[0].children[0]
//                                    .children[1].children[1].children[0].children[count]
//                                    .children[0].children[1]);
                                         
                                         
                        if(a1.children[0].children[0].children[0].children[0]
                                        .children[1].children[1].children[0].children[count]==undefined){
                            window.requestAnimationFrame(Looping(count));
                           }else{
                              if(a1.children[0].children[0].children[0].children[0]
                                        .children[1].children[1].children[0].children[count]
                                  ...
                                  if(a1.children[0].children[0].children[0].children[0]
                                     ...
                                     window.requestAnimationFrame(Looping(count)); 
                                      ...
                                      if(a1.children[0].children[0].children[0].children[0]
                                        .children[1].children[1].children[0].children[count]
                                        .children[0].children[1].children[0]== undefined){
                                          window.requestAnimationFrame(Looping(count));
                                      }else{
                                          if(a1.children[0].children[0].children[0].children[0]
                                        .children[1].children[1].children[0].children[count]
                                        .children[0].children[1].children[0].children[0] == undefined){
                                              window.requestAnimationFrame(Looping(count));
                                          }else{
                                              if(a1.children[0].children[0].children[0].children[0]
                                        .children[1].children[1].children[0].children[count]
                                        .children[0].children[1].children[0].children[0].children[3] == undefined){
                                                  window.requestAnimationFrame(Looping(count));
                                         ...
                                         person.push(details);
                                           count++;
                                           console.log("details are ",details,"value of count is ",count);
                                           Looping(count);
                                                }  
